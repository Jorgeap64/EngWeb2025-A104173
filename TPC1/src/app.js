...
import { normalizeJSON } from '../scripts/normalize.js';
...
const inputFilePath = path.resolve( __dirname , "../../dataset/dataset_reparacoes.json" );
...
// start json-server
const jsonServerCommand = `json-server --watch "${ outputFilePath }"`;
